...
class LaserScan(_object):
    ...
    __swig_setmethods__["size"] = _ydlidar.LaserScan_size_set
    __swig_getmethods__["size"] = _ydlidar.LaserScan_size_get
    if _newclass:
        size = _swig_property(_ydlidar.LaserScan_size_get, _ydlidar.LaserScan_size_set)
